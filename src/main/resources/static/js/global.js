...
/**
 * 设置ajax请求公共参数，如果ajax请求设置了参数，则覆盖本函数的默认设置 
 * 对ajax请求错误进行统一异常处理,若$.ajax请求自定义了error回调，则不会执行本函数，而是执行自定义的回调函数
 * 
 * @returns
 */
$(function() {
...
/**
 * 自定义ajax请求，TODO 未调试完成 
 * 拦截$.ajax请求的success回调函数，在请求正常返回的情况下获取后台传递的错误信息并进行统一的处理
