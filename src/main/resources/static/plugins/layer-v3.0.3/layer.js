...
!function (e, t) {
    ...
    r = {
        ...
        error: function (e, n, a) {//          基怀志  扩展方法
            var s = "function" == typeof n,
            f = o.config.skin,
            c = (f ? f + " " + f + "-msg" : "") || "layui-layer-err",
            u = l.anim.length - 1;
            return s && (a = n),
            r.open(i.extend({
                    content: e,
        ...
        warning: function (e, n, a) {//          基怀志  扩展方法
            var s = "function" == typeof n,
            f = o.config.skin,
            c = (f ? f + " " + f + "-msg" : "") || "layui-layer-war",
            u = l.anim.length - 1;
            return s && (a = n),
            r.open(i.extend({
                    content: e,
        ...
        success: function (e, n, a) {//          基怀志  扩展方法
            var s = "function" == typeof n,
            f = o.config.skin,
            c = (f ? f + " " + f + "-msg" : "") || "layui-layer-suc",
            u = l.anim.length - 1;
            return s && (a = n),
            r.open(i.extend({
                    content: e,
        ...
        info: function (e, n, a) {//          基怀志  扩展方法
            var s = "function" == typeof n,
            f = o.config.skin,
            c = (f ? f + " " + f + "-msg" : "") || "layui-layer-info",
            u = l.anim.length - 1;
            return s && (a = n),
            r.open(i.extend({
                    content: e,
